            ...
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <div className='flex items-center gap-2 mt-4'>
                        <Badge className='text-blue-700 font-bold px-1.5' variant="ghost">
                            {singleJob?.position} Positions
                        </Badge>
                        <Badge className='text-[#F83002] font-bold px-1.5' variant="ghost">
                            {singleJob?.jobType}
                        </Badge>
                        <Badge className='text-[#7209b7] font-bold px-1.5' variant="ghost">
