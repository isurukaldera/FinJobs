    ...
    const applyJobHandler = async () => {
        ...
        try {
            const response = await axios.post(
                'https://finjobs-1-backend.onrender.com/api/v1/application/apply/6746f8c70829731a773c683d',
                { /* your payload, such as job application details */ },
                {
                    headers: {
                        'Authorization': `Bearer ${userToken}`  // Ensure the token is sent here
                    }
                }
            );
